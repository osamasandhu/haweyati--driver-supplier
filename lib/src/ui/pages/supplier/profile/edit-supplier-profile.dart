        ...
        child: Form(
          ...
          child: Column(children: <Widget>[
            ...
            LocationPickerWidget(
              ...
              onChanged: (LocationPickerData loc){
                pickerData = loc;
                print(pickerData.address);
                print(pickerData.position.longitude);
              },
            ),
            SizedBox(height: 15,),
            Padding(
              ...
              child: StackButton(buttonName: "Save",onTap: () async{
                ...
                if(form.currentState.validate()){
                  ...
                  FormData profile = FormData.fromMap({
                    ...
                    'name' : name.text,
                    'latitude' : pickerData.position.latitude,
                    'services' : services,
                    'longitude' : pickerData.position.longitude,
