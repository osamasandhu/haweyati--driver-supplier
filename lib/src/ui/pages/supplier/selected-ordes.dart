...
import 'file:///C:/Users/Osama/Workspace/haweyati_supplier_driver_app/lib/src/ui/pages/supplier/viewallselectedorders.dart';
...
//
//
//  child:Text("Al Kabi Store ",style: TextStyle(fontWeight: FontWeight.bold),)
//    ),
                            ...
                            SizedBox(height: 20),
                      Row(children: <Widget>[Icon(Icons.location_on,color: Colors.red,) ,SizedBox(width: 10,), Expanded(child: Text("address"))]),
                            SizedBox(height: 15),
