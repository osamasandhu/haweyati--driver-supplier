...
class VehicleType extends HiveObject{
  ...
  VehicleType({this.image,this.name,this.minVolume,this.minWeight,this.id,this.maxVolume,this.maxWeight});
  ...
  Map<String,dynamic> toJson()=> {'name' : name,'minWeight' : minWeight, 'maxWeight' : maxWeight,'minVolume' : minVolume, 'maxVolume' : maxVolume,'image' : image.toJson(),'_id' : id};
}